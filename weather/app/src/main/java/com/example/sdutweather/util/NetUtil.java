package com.example.sdutweather.util;
...
public class NetUtil {
    public static final String URL_WEATHER_WITH_FUTURE = "http://v1.yiketianqi.com/api?unescape=1&version=v9&appid=34535781&appsecret=PI1GYfRy";
